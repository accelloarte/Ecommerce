...
_Se ha agregado el proyecto "ECommerce.Entities\ECommerce.Entities.csproj" a la solución._

`dotnet sln add .\ECommerce.DataAccess\`

_Se ha agregado el proyecto "ECommerce.DtaAccess\ECommerce.DataAccess.csproj" a la solución._

`dotnet sln add .\ECommerce.Dto\`

_Se ha agregado el proyecto "ECommerce.Dto\ECommerce.Dto.csproj" a la solución._
...
_La herramienta "dotnet-ef" se reinstaló con la versión estable más reciente (versión "6.0.4")._
